  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5 `}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi , I'm <span className='text-[#7a50d5]'>Harsh</span></h1>
          <p className={`${styles.heroSubText} mt-2`}> I am MERN stack Developer, <br className='sm:block hidden' />
         I develop 3d visuals.</p>
        </div>
      </div>
